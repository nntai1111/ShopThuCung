<%-- 
    Document   : viewKH
    Created on : Mar 6, 2024, 9:45:24 PM
    Author     : giang
--%>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header d-flex">
                                    ...
                                    <span class=" col-sm-11 p-0 d-flex justify-content-end">
                                        <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal">
                                        <i class="bi bi-plus"></i> <span>Add New Employee</span></a>
                                    </span>
                                </div>
                                <div class="card-body">
                                    <%
                                        ArrayList<Account> list = (ArrayList) request.getAttribute("listCustomer");
                                    ...
                                    <table id="bootstrap-data-table" class="table table-hover table-striped table-bordered text-center">
                                        ...
                                        <%
                                            for (Account acc : list) {
                                                if (acc.getStatus() != 0 && acc.getRole().equalsIgnoreCase("User")) {
                                        %>

                                        <form>
                                            <input type='hidden' value="<%= acc.getId()%>" name='txtaccid'/> 
                                            <tr>
                                                <td><%=  acc.getId()%> </td>
                                                <td><%=  acc.getFullname()%> </td>
                                                <td><%=  acc.getPhonenumber()%> </td>
                                                <td><%=  acc.getRegisterDate()%> </td>
                                                <td class="d-flex justify-content-center">
                                                    ...
                                                    <form action='mainController' method='post'>
                                                        <input type='hidden' value="<%= acc.getId()%>" name='txtaccid'/> 
                                                        <p>
                                                            <button data-toggle="modal" data-target="#flipFlop" class="button_view" type="submit" name="editBtn"><i class="bi bi-eye"></i></button>
                                                            <input type="hidden" value="viewinfocustomer" name="action"/>
                                                        </p>
                                                    </form>
                                                    ...
                                                    <form action='mainController' method='post'>
                                                        <input type='hidden' value="<%= acc.getId()%>" name='txtaccid'/> 
                                                        <p>
                                                            <button class="button_view" type='submit'  onclick="return window.confirm('Are you sure ?')"><i class="bi bi-trash3"></i></button>
                        ...
                        <form action="mainController" method="post">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="txtfullname" id="fullname" required placeholder="Enter your full name">
                                </div>
                                <div class="form-group">
                                    <label>Phone Number</label>
                                    <input type="text" class="form-control" name="txtphonenumber" id="phonenumber" required pattern="[0-9]{10}" placeholder="Enter your 10-digit phone number">
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="email" class="form-control" name="txtemail" id="email" required pattern="[a-zA-Z0-9._%+-]+@gmail.com" placeholder="Enter your Gmail address">
                                </div>
                                <div class="form-group">
                                    <label>Password</label>
                                    <input type="password" class="form-control" name="txtpassword" id="password" required placeholder="Enter a password">
                                </div>
                                <div class="form-group">
