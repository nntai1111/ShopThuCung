<%-- 
    Document   : adminhome
    Created on : Mar 2, 2024, 6:48:06 PM
    Author     : ADMIN
--%>
...
<!--                        <li class="active">
                            <form action="mainController" method="post" >    
                                                                <i class="menu-icon fa fa-laptop"></i><button class="button_service_das" type="submit" value="adminhome" name="action">Dashboard</button>
                                <li><i class="fa fa-table"></i><button class="button_service" type="submit" value="dashboard" name="action">Data</button></li>
                            </form>
                        </li>-->
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <form action="mainController" method="post" >                              
                                <ul class="sub-menu children dropdown-menu">
                                    ...
                                    <li><i class="fa fa-table"></i><button class="button_service" type="submit" value="dashboard" name="action">Booking</button></li>
                                    <li><i class="fa fa-table"></i><button class="button_service" type="submit" value="dashboard" name="action">Invoice</button></li>
                                                ...
                                                <div class="card-body">
                                                    <div class="stat-widget-five">
                                                        ...
                                                        <div class="stat-content">
                                                            <div class="text-left dib">
                                                                <div class="stat-text"><span class="count">1</span></div>
                                                                <div class="stat-heading">Quantity of Orders</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
